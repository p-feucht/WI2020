<?php
    ...
    $query = mysqli_query($db_link, "SELECT * FROM `Bestellungsanfragen` WHERE Username = '$username'") or die('Fehler: ' . mysqli_error());
    ...
    if($resultCheck > 0){
        ...
        echo('<h1>Es wurden keine Käufe gefunden!</h1>');
    }
    echo('</div>');
?>
