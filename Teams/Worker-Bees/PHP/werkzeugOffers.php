...
if ($result->num_rows > 0) {
    ...
    ?>
        ...
        <div class="card" id=<?php echo $card_ID ?> data-toggle="modal" data-target=<?php echo $modal_target ?>>
            ...
            alt="Offer Photo" class="offer-image"/>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3 class="modal-offerName" name="Titel"><?php echo $title ?></h3>
                    ...
                    <div class="modal-content-split">
                        <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($image); ?>" 
                            alt="Offer Photo" class="modal-image"/>
                    </div>
                    ...
                    <form class="modal-booking-window" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                        <h3 class="modal-booking-heading">Nur noch ein Schritt!</h3>
                            ...
                            <input type="date" id="bookingDate" name = "Datum" value="<?php echo htmlspecialchars($date);?>" required><br>

                            <p class="modal-booking-text">Gesamtbetrag: <em name="Preis"><?php echo $price ?></em> €<br></p>
