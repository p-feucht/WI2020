...
<body>
    <nav>
        ...
        <div id="menu">
            <ul class="horizontal">      
                <li><a href="php/eingabe.php" class="button">Eingabe Lebensmittel</a></li>
                <li><a href="php/rezepte.php" class="button">Rezepte</a></li>
                <li><a href="php/rezeptidee.php"class="button">Rezeptidee</a></li>
                <li><a href="php/tipps.php"class="button">Tipps und Tricks</a></li>
            </ul>
        </div>
    </nav>
    ...
    <footer>
        <div id="buttom">
            <ul class="horizontal">
                <li><a href="php/impressum.php"class="button">Impressum</a></li>
                <li><a href="php/kontakt.php" class="button">Kontakt</a></li>
            </ul> 
        </div>
    </footer>
</body>